package com.service.vedio.vedio_service.config;
...
public class AppConstants {
    ...
    public static final String DEFAULT_BASE_URL="http://category-service/api/v1";
    public static final String VIDEO_SERVICE_BASE_URL="http://vedio-services/api/v1";
}